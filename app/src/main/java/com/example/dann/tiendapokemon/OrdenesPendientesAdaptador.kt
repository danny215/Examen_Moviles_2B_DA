...
class OrdenesPendientesAdaptador(private val ordenesList: List<OrdenCompraKotlinClass>) :  RecyclerView.Adapter<OrdenesPendientesAdaptador.MyViewHolder>(){
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view), View.OnCreateContextMenuListener {
        ...
        lateinit var ordenn: OrdenCompraKotlinClass

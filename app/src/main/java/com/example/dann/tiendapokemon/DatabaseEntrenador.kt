...
class DatabaseEntrenador{
    ...
    companion object {
        ...
        fun insertarEntrenador(entrenador:Entrenador){
            "http://172.29.64.32:1337/Entrenador".httpPost(listOf("nombre" to entrenador.nombre, "apellido" to entrenador.apellido, "fechaNacimiento" to entrenador.fechaNacimiento, "medallas" to entrenador.numeroMedallas, "campeonActual" to entrenador.campeonActual))
        ...
        fun eliminarEntrenador(id: Int) {
            "http://172.29.64.32:1337/Entrenador/$id".httpDelete()
        ...
        fun actualizarEntrenador(entrenador: Entrenador) {
            "http://172.29.64.32:1337/Entrenador/${entrenador.id}".httpPut(listOf("nombre" to entrenador.nombre, "apellido" to entrenador.apellido, "fechaNacimiento" to entrenador.fechaNacimiento, "medallas" to entrenador.numeroMedallas, "campeonActual" to entrenador.campeonActual))
                    .responseString { request, _, result ->
                        Log.d("http-ejemplo", request.toString())
                    }
        }
        ...
        fun getList(): ArrayList<Entrenador> {
            ...
            val (request, response, result) = "http://172.29.64.32:1337/Entrenador".httpGet().responseString()
